...
<div class="wrapper">
	...
	<form id="frmLogin" name="frmLogin">
		...
		<%-- 암호 --%>
		<div class="form-group">
			<input type="password" name="userPw" id="userPw" class="form-control" placeholder="암호"/><br><br>
		</div>
...
<script type="text/javascript">
	...
	$("#sendMember").on("click",function(){
		...
		frmLogin.attr("method","post"); //메서드 속성은 post로 URL(주소)에 값을 안 보이게
		frmLogin.attr("action","/member/login"); //값을 보낼 경로
		frmLogin.submit(); //전송
	});
</script>
</body>
